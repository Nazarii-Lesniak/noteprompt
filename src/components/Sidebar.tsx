...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`fixed inset-y-0 w-full md:w-72 lg:w-80 left-0 backdrop-blur-md border-r-4 rounded-3xl border-sky transition-transform duration-300 ease-in-out ${
